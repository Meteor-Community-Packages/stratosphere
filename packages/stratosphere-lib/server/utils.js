 ...
 * @returns {boolean}
 */
Stratosphere.utils.validatePackageName = function(){
  try{
 ...
 * @returns {boolean}
 */
Stratosphere.utils.validateVersion = function(){
  try{
 ...
 * @returns {boolean}
 */
Stratosphere.utils.verifyHashes = function(files){
 ...
 * @returns {boolean}
 */
Stratosphere.utils.verifyHash = function(file,hash){
...
Stratosphere.utils.checkAccess = function(){
  if(Meteor.settings.public.loginRequired && !Meteor.user()) throw new Meteor.Error("403");
}


Stratosphere.utils.versionMagnitude = function(version){
