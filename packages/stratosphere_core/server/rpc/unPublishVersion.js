...
Meteor.methods({
  ...
  unPublishVersion:function(id){
    ...
    if(pack.latestVersion.id === version._id){
      const latestVersion = Versions.findOne({packageName:version.packageName},{sort:{versionMagnitude:1},fields:{description:1,version:1}});
